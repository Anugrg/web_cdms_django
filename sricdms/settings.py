"""
Django settings for sricdms project.
...
SECRET_KEY = 'django-insecure-)!lf2z538oqrk(xxh1tv*kzxr8k7!uui@r(50j%*%hyk_^=9q&'
...
WSGI_APPLICATION = 'sricdms.wsgi.application'
